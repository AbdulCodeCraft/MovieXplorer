...
export const MovieDetails = (props) => {
  ...
  return <div className="h-screen bg-primary flex justify-center pt-10">
     <div className="flex h-[75%] object-contain w-[75%] rounded-md overflow-hidden shadow-2xl  bg-black/50">
      ...
      <div className="text-white px-10 py-15 space-y-3">
        ...
        <p>{movie.overview}</p>
        <button className="px-10 py-3 bg-fourth text-primary rounded-md " onClick={()=>window.open(imdb)}>
          Watch on IMDB
        </button>
